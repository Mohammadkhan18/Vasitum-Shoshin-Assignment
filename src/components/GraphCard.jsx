        ...
        <div className="flex flex-col gap-4 m-4 md:grid md:grid-cols-2">
            <div className="border border-gray-300 rounded-lg flex flex-row justify-between p-2">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <img src={vector} alt='vector' className='w-30 h-30 pr-3 pb-5 class="absolute top-0 left-0 '/>
                    <img src={graph} alt='graph' className='absolute top-0 left-0 w-30 h-30 pb-5'/>
                    </div>
