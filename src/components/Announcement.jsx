            ...
            <div className="bg-[#FAFAFA] border border-gray-200 rounded-md p-3 mb-2 hover:bg-[#ececec] dark:bg-[#2f2b3a] dark:border-[#2f2b3a]">
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <div className="flex flex-row gap-2">
                        <img src = {title ==="Outing schedule for every department"? pin: unpin} alt="pin" className="w-9 h-9 hover:bg-gray-200 hover:rounded-full p-1"/>
                        <img src = {dots} alt="dots" className="w-9 h-9 hover:bg-gray-200 hover:rounded-full p-1"/> 
                    </div>
                </div>
            </div>
        )
    ...
    return(
        <div className="flex flex-col">
            ...
            <div className="border border-gray-200 dark:border-[#2f2b3a] flex flex-row p-1 justify-between rounded-md gap-1">
                ...
                <img src={thindropdown} alt="drowp-down" className="w-4 h-4"/>
            </div>
            </div>
            <div className="announcement-container overflow-y-auto scrollbar-thin scrollbar-thumb-gray-100 scrollbar-track-transparent max-h-80">
                    <Card title="Outing schedule for every department" time="5 Minutes ago"/>
                    <Card title="Meeting HR department" time="Yesterday, 12:30 PM"/>
                    <Card title="IT Department need two more talents for UX/UI Designer position" time="Yesterday, 09:15 AM"/>
                </div>    
        </div>
