  ...
  return (
    <div className="m-4 text-white flex flex-col items-stretch min-h-80 md:min-h-80 md:max-h-96 lg:max-h-80 ">
      ...
      <div className='p-5 rounded-b-lg bg-[#161E54] flex flex-col'>
        ...
        <span className='text-xs mb-4 text-[#FFFFFF] font-sans'>12.40 AM, Thu 02 Sep 2024</span>
        ...
        <button className='p-2 bg-[#FF5151] justify-start rounded-lg w-1/2 hover:bg-white hover:text-[#FF5151] md:mb-6 lg:mb-0'>See All Activity</button>
      </div>
      </div>
